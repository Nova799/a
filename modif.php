...
if (isset($_GET["id"])) {
  ...
  if (isset($_GET["myself"])) {
    if ($_GET["myself"] == "true") {
      mysqli_query($conn, "UPDATE nom_table SET isChanged = 1, canChange = 1 WHERE id = " . $_GET['id'] . " AND canChange = 0 AND isChanged = 0");
    } else {
      ?>
  ...
  <main id="main">
    ...
    <div class="form">
      ...
      <div class="mobile-div">
        ...
        <div class="input-div">
          <input type="input" name="attentes" placeholder="Your answwer"
            value="<?= $row['attentes'] ? $row['attentes'] : 'Vide' ?>">
        </div>
      </div>
      ...
      <div class="mobile-div">
        ...
        <div class="input-div">
          <input type="input" name="autres_priorites" placeholder="Your answwer"
            value="<?= $row['autres_priorites'] ?>">
        </div>
      </div>
      ...
      <div class="last-div">
        <p class="never text-center">
          <a class="btn btn-secondary float-start" href="./makePdf.php?id=<?= $_GET['id'] ?>" download>Télécharger</a>
    ...
    document.querySelector("#btn").onclick = function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          // if (<?php if (isset($_GET["myself"]) && $_GET["myself"] == "true") { ?>true<?php } else { ?>false<?php } ?>) {
          setTimeout(function () {
            window.close();
          }, 200)
          // }
